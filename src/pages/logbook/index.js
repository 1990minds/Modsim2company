...
import {fetchAllCompanyLog, logSelector} from '../../api/log'
...
export default function Database() {
  ...
  const { user } = useSelector(authenticateSelector) 
    ...
    useEffect(()=>{
      ...
      dispatch(fetchAllCompanyLog(user?._id))
  ...
  useEffect(()=>{
    ...
    axios.get(keyUri.BACKEND_URI +`/company-log/${user?._id}?search=${debouncedText}`).then(({data})=>{
